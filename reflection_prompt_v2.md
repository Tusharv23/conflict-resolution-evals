...
- **Durability**: When reviewing multiple transcripts, prefer durable patterns supported across sessions and avoid recording one-off task state.
...
- **Restraint**: Never weaken confirmed safety-critical facts like medical-conditions, allergies, dependents on anecdote, keep the fact unchanged, optionally record the anecdote as unverified 
